...
SpecificEntry migration:
* change everything that uses file? or directory? in Entry
* change everything that uses file? or directory? everywhere else
* remove Entry.file? and Entry.directory?
  * both in Entry and SpecificEntries
  * tests may use .is_a? or monkey patch the methods
