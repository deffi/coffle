...
* coffle build in uninitialized directory fails
* symlink to coffle script does not work
* Symlink removed: should reinstall
...
* Test: target path contains symlinks

* Build in subdirectory of coffle directory

* SSH: support
  * quoted spaces in command
  * quoted quotes in command
  * quoted backslashes in command
  * SSH1 keys
