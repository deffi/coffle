...
module Coffle
	module TemplateMethods
		def automessage(comment="# ", width=80)
			...
			message=<<-end
This file was autogenerated from #{source} by #{username}@#{hostname} on #{time}. You should not make any changes here, as they may be overwritten when the file is regenerated.
